...
class WeatherMapperSpec extends BaseSpecification {
    ...
    def "test map weather from json string success with unknown properties"() {
        // To test the objectMapper can read unknown values, in case API updates

        given:
        def openWeatherApiResponse = openWeatherResponseUnknownProperties()
